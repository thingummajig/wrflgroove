...
urlpatterns = patterns('',
        url(r'^$', 'django.views.generic.simple.direct_to_template', { 'template': '/home/thingummajig/mysite/static/templates/index.html' }),
        url(r'^wrflgroove/$', 'django.views.generic.list_detail.object_list', { 'queryset': Playlist.objects.all() }),  
